...
const Hero = () => {
    return (
        <div className='w-2/3 md:w-full mt-10 text-center flex flex-col gap-2'>
            <h1 className='text-[70px] md:text-[50px] font-bold'>Transfer your files across multiple devices.</h1>
